...
public class MainEmployeeTask4 {
	...
	public static void main(String[] args) {
		...
		List<String> collectedDate = employees.stream()
				.filter(e -> !((e.getYearsOfExprience() < 3) && !(e.getJobTitle().equalsIgnoreCase("IT"))
						&& (e.getPerformanceRating() < 8)))
				.sorted(Comparator.comparing(Employee::getPerformanceRating).reversed()
						.thenComparing(Employee::getYearsOfExprience))
